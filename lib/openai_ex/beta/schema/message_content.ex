defmodule OpenaiEx.Beta.Schema.MessageContent do
  use Ecto.Schema
  import Ecto.Changeset

  alias __MODULE__.{Text, Image}
...
defmodule OpenaiEx.Beta.Schema.MessageContent.Text do
  use Ecto.Schema
  import Ecto.Changeset
...
defmodule OpenaiEx.Beta.Schema.MessageContent.Image do
  use Ecto.Schema
  import Ecto.Changeset
